...
description: 'This guide shows how to get started with the popular MediaWiki Engine for powering Wiki Sites on Ubuntu 16.04.'
keywords: ["mediawiki", "wiki", "web-applications"]
tags: ["wiki","ubuntu"]
license: '[CC BY-ND 4.0](https://creativecommons.org/licenses/by-nd/4.0)'
aliases: ['/websites/wikis/mediawiki-engine/','/websites/wikis/install-mediawiki-on-ubuntu-1604/','/web-applications/wikis/mediawiki/']
modified: 2019-08-23
modified_by:
  name: Linode
