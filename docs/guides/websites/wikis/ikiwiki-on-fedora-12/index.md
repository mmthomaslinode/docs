...
description: 'This guide shows you how to install, configure, and use the free and open-source Wiki app - Ikiwiki - on Fedora 12 to power a standard wiki implementation.'
